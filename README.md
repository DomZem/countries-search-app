[<img src=".github/readmeHeaderImage.png" alt="countries app banner" width="100%"/>](https://DomZem.github.io/countries-api)
<h2 align="left">Search countries - app for searching and filtering countries from API</h4>
<h3 align='left'>About project 🔍</h3> 
<p align='left'>Solution of frontend mentor challenge. The application generates a list of countries taken from the API. You can also click on any country item to get more information about it.</p>
